...
public class YoutubeMessageHandler implements MessageHandlers {
    ...
    List<String> urls = List.of("https://www.youtube.com/watch?","https://youtu.be","https://youtube.com/watch?","https://youtube.com/shorts","https://www.youtube.com/shorts");
    @Override
    ...
    public void handle(MessageEvent event) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                SendMessage search = new SendMessage(String.valueOf(update.getMessage().getChatId()),"Начинаем поиск...");
                ...
                if(responseDto==null){
                    ...
                    sendMessage.setText("Произошла ошибка при загрузке видео!");
                ...
                if(responseDto.getYoutubeQuality().isEmpty()){
                    ...
                    sendMessage.setChatId(searchMessage.getChatId());
                    sendMessage.setMessageId(searchMessage.getMessageId());
                    sendMessage.setText("Видео не было найдено!");
                    sendTelegram.editMessage(sendMessage);
                ...
                sendMessage.setChatId(searchMessage.getChatId());
                sendMessage.setMessageId(searchMessage.getMessageId());
                sendMessage.setText("Найдено видео по ссылке: "+message+"\n"+responseDto.getVideoName());
                ...
                if(videoData==null){
                    ...
                    messageError.setText("Ошибка при сохранении результатов!");
            ...
            private static List<List<InlineKeyboardButton>> getLists(ResponseDto responseDto, VideoDataEntity videoData) {
                ...
                for(YoutubeQuality quality: responseDto.getYoutubeQuality()){
                    ...
                    button.setText("Качество: "+quality.getFormat_note()+", "+quality.getSize()+"Mb");
